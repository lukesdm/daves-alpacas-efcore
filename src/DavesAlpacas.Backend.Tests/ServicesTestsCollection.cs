...
namespace DavesAlpacas.Backend.Tests
{
    /// <summary>
    /// Definition of the Services Tests Collection
    /// </summary>
    [CollectionDefinition(nameof(ServicesTestsCollection))]
    public class ServicesTestsCollection : ICollectionFixture<ServicesTestsCollectionFixture>
    {
        // Nothing to do
    }
}
